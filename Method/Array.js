...
//  Last element remove karta hai aur return karta hai
// Output: 5 [1,2,3,4]
...
//  First element remove karta hai aur return karta hai
// Output: 1 [2,3,4,5]
...
//  Beech me elements remove aur add karta hai
// Output: [1,'a','b',4,5]
...
//  Array ko ascending order me sort karta hai (default string compare)
// Output: [1,2,3,4]
...
//  Array order ko ulta kar deta hai
// Output: [4,3,2,1]
...
//  Start-end index ke beech value se fill karta hai
// Output: [1,0,0,4]
...
//  Array ke part ko copy karke dusre index par replace karta hai
// Output: [1,3,4,4]
...
//  Arrays ko merge karta hai aur naya array return karta hai
// Output: [1,2,3,4,5,6,7]

// 11. join()
let arr_join = arr1.join("-");
console.log("11. join('-'):", arr_join);
//  Array elements ko string me separator ke sath join karta hai
// Output: "1-2-3-4-5"

// 12. slice()
let arr_slice = arr1.slice(1,4);
console.log("12. slice(1,4):", arr_slice);
//  Array ka part nikalta hai, original change nahi hota
// Output: [2,3,4]

// 13. includes()
let arr_includes = arr1.includes(3);
console.log("13. includes(3):", arr_includes);
//  Check karta hai element exist karta hai ya nahi, Boolean return karta hai
// Output: true
...
//  Array ke numbers ko local format me convert karta hai
// Output: "123,456"
...
//  Har element pe function run karta hai, return nahi karta
