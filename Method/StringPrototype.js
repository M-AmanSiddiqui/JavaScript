...
//  Ye property string ke characters ki total count return karti hai.
...
//  Is method se tu string ke kisi specific index ka character nikal sakta hai.
...
//  Ye method string ke character ka Unicode (ASCII) code number return karta hai.
...
//  Unicode code point return karta hai. Extended Unicode characters ke liye useful.
// Output: 72

// 5. concat()
let str_concat = str.concat("!", " JS");
console.log("5. concat('!',' JS'):", str_concat);
//  Multiple strings ko combine karke ek naya string return karta hai.
...
//  Check karta hai substring exist karti hai ya nahi. Boolean return karta hai.
// Output: true

// 7. endsWith()
let str_endsWith = str.endsWith("World");
console.log("7. endsWith('World'):", str_endsWith);
//  Check karta hai string ka last part specified substring se match karta hai ya nahi.
// Output: true

// 8. startsWith()
let str_startsWith = str.startsWith("Hello");
console.log("8. startsWith('Hello'):", str_startsWith);
//  Check karta hai string ka start specified substring se match karta hai ya nahi.
// Output: true

// 9. indexOf()
let str_indexOf = str.indexOf("o");
console.log("9. indexOf('o'):", str_indexOf);
//  Ye method substring/character ka **first occurrence index** return karta hai. Agar nahi mile to -1.
// Output: 4

// 10. lastIndexOf()
let str_lastIndexOf = str.lastIndexOf("o");
console.log("10. lastIndexOf('o'):", str_lastIndexOf);
//  Ye method substring/character ka **last occurrence index** return karta hai.
// Output: 7

// 11. slice()
let str_slice = str.slice(0,5);
console.log("11. slice(0,5):", str_slice);
//  Start aur end index ke beech ka part extract karta hai aur naya string return karta hai.
