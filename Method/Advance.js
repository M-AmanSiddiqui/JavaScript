...
// Roman: exec() method string me pattern match dhundta hai aur first match ka array return karta hai.
...
// Roman: test() method check karta hai ki pattern string me exist karta hai ya nahi. Agar match ho jaye to true, nahi to false return karta hai.
// Output: true

// 3. toString()
let regex_str = /abc/i.toString();
console.log("3. /abc/i.toString():", regex_str);
// Roman: Regular expression ko string me convert karta hai. Flags (i,g,m) bhi string me include hoti hai.
// Output: "/abc/i"
...
// Roman: compile() method pattern ko dobara compile karta hai. Ye mostly use nahi hota aur modern JS me discouraged hai.
// Output: /y/
...
// Roman: set() method ek key-value pair Map me store karta hai. Agar key pehle exist karti hai to update kar deta hai.
// Output: Map(1) { 'a' => 100 }

// 2. get()
let map_get = map1.get("a");
console.log("2. map1.get('a'):", map_get);
// Roman: get() method key ke corresponding value return karta hai. Agar key exist nahi karti to undefined return karta hai.
// Output: 100

// 3. has()
let map_has = map1.has("a");
console.log("3. map1.has('a'):", map_has);
// Roman: has() method check karta hai ki given key Map me exist karti hai ya nahi. Boolean return karta hai.
// Output: true

// 4. delete()
map1.delete("a");
console.log("4. map1.delete('a'):", map1);
// Roman: delete() method given key-value pair ko Map se remove karta hai.
// Output: Map(0) {}

// 5. clear()
map1.set("b",200); map1.clear();
console.log("5. map1.clear():", map1);
// Roman: clear() method Map ke sab key-value pairs remove karta hai.
// Output: Map(0) {}
...
// Roman: forEach() method har key-value pair pe function run karta hai, output me custom action perform kar sakte ho.
// Output: x 1
//         y 2

// 7. keys()
console.log("7. map1.keys():", [...map1.keys()]);
// Roman: keys() method Map ki sari keys ka iterator return karta hai, spread operator se array me convert kiya.
// Output: ["x","y"]

// 8. values()
console.log("8. map1.values():", [...map1.values()]);
// Roman: values() method Map ki sari values ka iterator return karta hai.
// Output: [1,2]

// 9. entries()
console.log("9. map1.entries():", [...map1.entries()]);
// Roman: entries() method Map ka [key,value] pair ka iterator return karta hai.
// Output: [["x",1],["y",2]]
...
// Roman: add() method Set me value add karta hai. Duplicate values ignore hoti hain.
// Output: Set(1) {10}

// 2. has()
console.log("2. set1.has(10):", set1.has(10));
// Roman: has() method check karta hai ki value Set me exist karti hai ya nahi.
// Output: true

// 3. delete()
set1.delete(10);
console.log("3. set1.delete(10):", set1);
// Roman: delete() method value Set se remove karta hai.
// Output: Set(0) {}

// 4. clear()
set1.add(5); set1.add(6); set1.clear();
console.log("4. set1.clear():", set1);
// Roman: clear() method Set ke sab elements remove karta hai.
// Output: Set(0) {}
...
// Roman: forEach() method Set ke har element pe function run karta hai.
// Output: 1
//         2
...
// Roman: values() aur keys() same iterator return karte hain (Set me key=value hota hai).
// Output: [1,2]

// 7. entries()
console.log("7. set1.entries():", [...set1.entries()]);
// Roman: entries() method Set ke element ka [value,value] pair iterator return karta hai.
// Output: [[1,1],[2,2]]
...
// Roman: then() method success callback run karta hai jab promise resolved ho jaye.
// Output: Done

// 2. catch()
let promise2 = new Promise((resolve,reject)=>reject("Error"));
promise2.catch(err=>console.log("2. promise2.catch():", err));
// Roman: catch() method error callback run karta hai jab promise reject ho jaye.
// Output: Error

// 3. finally()
promise1.finally(()=>console.log("3. promise1.finally(): Done"));
// Roman: finally() hamesha run hota hai, chahe promise resolve ho ya reject.
// Output: Done

// 4. all()
Promise.all([Promise.resolve(1), Promise.resolve(2)])
.then(res=>console.log("4. Promise.all():", res));
// Roman: all() tab resolve hota hai jab sab promises complete ho jaye, array return karta hai.
// Output: [1,2]

// 5. race()
Promise.race([Promise.resolve(1), Promise.resolve(2)])
.then(res=>console.log("5. Promise.race():", res));
// Roman: race() pehla complete promise ka result return karta hai.
// Output: 1

// 6. allSettled()
Promise.allSettled([Promise.resolve(1), Promise.reject("Err")])
.then(res=>console.log("6. Promise.allSettled():", res));
// Roman: allSettled() sab promises ka result deta hai, chahe resolve ho ya reject.
...
// Roman: Error ka message return karta hai.
// Output: Something went wrong

// 2. name
console.log("2. err1.name:", err1.name);
// Roman: Error ka type return karta hai, default "Error" hota hai.
// Output: Error

// 3. stack
console.log("3. err1.stack:", err1.stack);
// Roman: Error ka stack trace return karta hai, code execution path dikhata hai.
// Output: Error: Something went wrong at ...

// 4. toString()
console.log("4. err1.toString():", err1.toString());
// Roman: Error object ko string me convert karta hai.
...
// Roman: Function ko call karta hai aur 'this' ko bind karta hai
...
// Roman: Function ke parameters ka count return karta hai
// Output: 2

// 6️⃣ name -----------------
let func_name = greet.name;
console.log("6. greet.name:", func_name);
// Roman: Function ka naam return karta hai
// Output: "greet"

// 7️⃣ prototype -----------------
console.log("7. greet.prototype:", greet.prototype);
// Roman: Har function ka prototype object hota hai (mostly for constructor functions)
// Output: { constructor: ƒ }

// 8️⃣ constructor -----------------
console.log("8. greet.constructor:", greet.constructor);
// Roman: Function ka constructor return karta hai (Function constructor)
